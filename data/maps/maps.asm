...
MapGroup_Dungeons:
	...
	map ViridianForest, TILESET_FOREST, INDOOR, LANDMARK_VIRIDIAN_FOREST, MUSIC_VIRIDIAN_FOREST, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map ViridianForestGateSouth, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestGateNorth, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
