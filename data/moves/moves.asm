...
Moves1:
	...
	move EFFECT_ATTACK_UP,           0, NORMAL,   STATUS,   100, 20,   0 ;GROWTH
	...
	move EFFECT_NORMAL_HIT,         40, DRAGON,   SPECIAL,  100, 10,   0 ;DRAGON_RAGE
	...
	move EFFECT_SLEEP,               0, PSYCHIC_TYPE,  STATUS,    70, 20,   0 ;HYPNOSIS
	...
	move EFFECT_DEFENSE_UP_2,        0, PSYCHIC_TYPE,  STATUS,   100, 20,   0 ;BARRIER
	...
	move EFFECT_CURSE,               0, CURSE,  STATUS,   100, 10,   0 ;CURSE
	...
	move EFFECT_FUTURE_SIGHT,      120, PSYCHIC_TYPE,  SPECIAL,  100, 10,   0 ;FUTURE_SIGHT
...
Moves2:
	...
	move EFFECT_RECOIL_HIT,        120, WATER,    PHYSICAL, 100, 15,   0 ;WAVE_CRASH
	...
	move EFFECT_FALSE_SWIPE,        40, NORMAL,   PHYSICAL, 100, 40,   0 ;HOLD_BACK
	...
	move EFFECT_SPEED_DOWN_HIT,     50, BUG,      PHYSICAL, 100, 20, 100 ;POUNCE
	move EFFECT_ATTACK_DOWN_HIT,    50, BUG,      SPECIAL,  100, 20, 100 ;CHILLNG_WTER
	...
	move EFFECT_SPEED_DOWN_HIT,     55, BUG,      SPECIAL,   95, 15, 100 ;ELECTROWEB
	...
	move EFFECT_POISON_HIT,         50, FIGHTING, PHYSICAL, 100, 25,   0 ;POISON_TAIL
	...
	move EFFECT_NORMAL_HIT,         90, GRASS,    PHYSICAL, 100, 15,   0 ;PETALBLIZZRD
	...
	move EFFECT_ALWAYS_HIT,         60, GRASS,    PHYSICAL, 100, 20,   0 ;MAGICAL_LEAF
	move EFFECT_ALWAYS_HIT,         60, ELECTRIC, PHYSICAL, 100, 20,   0 ;SHOCK_WAVE
	...
	move EFFECT_BURN_HIT,           80, WATER,    PHYSICAL, 100, 15,  30 ;SCALD
	...
	move EFFECT_SP_ATK_DOWN_2,       0, ELECTRIC, STATUS,   100, 15,   0 ;EERIEIMPULSE
	...
	move EFFECT_SLEEP,               0, GRASS,    STATUS,    55, 15,   0 ;GRASS_WHISTLE
