...
RuinsOfAlphOutside_MapEvents:
	...
	warp_event 12, 19, RUINS_OF_ALPH_INNER_CHAMBER, 1
	warp_event 19, 17, RUINS_OF_ALPH_RESEARCH_CENTER, 1
	warp_event  8, 25, UNION_CAVE_B1F, 1
	warp_event  8, 33, UNION_CAVE_B1F, 2
	...
	def_object_events
	object_event  6, 26, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 1, TrainerPsychicNathan, -1
